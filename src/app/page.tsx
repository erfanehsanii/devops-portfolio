    ...
    <main className="overflow-hidden">
      <section className="relative min-h-screen border-b border-slate-800">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-5 lg:px-8">
          ...
          <div id="top" className="flex min-h-[calc(100vh-88px)] max-w-4xl flex-col justify-center py-20">
            <p className="mb-5 font-mono text-sm text-cyan"><span className="mr-2 text-slate-500">01</span>AVAILABLE FOR THE NEXT CHALLENGE</p>
            ...
            <p className="mt-7 max-w-2xl text-xl leading-8 text-slate-300 sm:text-2xl">{tagline}</p>
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a href={github} target="_blank" rel="noreferrer" className="rounded-full border border-slate-600 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:border-cyan hover:text-cyan">View GitHub <span aria-hidden="true">↗</span></a>
            </div>
            <div className="mt-16 grid max-w-3xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-slate-800 bg-slate-800 sm:grid-cols-4">
              {portfolio.focus.map((item, index) => (
                <div key={item} className="bg-ink px-4 py-5">
                  <p className="mb-2 font-mono text-xs text-cyan">0{index + 1}</p>
      ...
      <section id="skills" className="section-anchor border-y border-slate-800 bg-[#0b1627]">
        <div className="mx-auto max-w-6xl px-6 py-24 lg:px-8">
          <SectionHeading eyebrow="03 / Toolkit" title="Technology with purpose." intro="Tools are chosen for resilience, clarity, and the needs of the team using them." />
      ...
      <section id="experience" className="section-anchor mx-auto max-w-6xl px-6 py-24 lg:px-8">
        <SectionHeading eyebrow="04 / Experience" title="Deep systems experience, from operations to platform engineering." />
